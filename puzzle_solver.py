...
class PuzzleSolver:
    ...
    def is_solvable(self) -> bool:
        ...
        initial_n: int = find_element(self.__initial_state, 0)[1] + __count_state_n(flt_initial) + 1
        final_n: int = find_element(self.__final_state, 0)[1] + __count_state_n(flt_final) + 1
